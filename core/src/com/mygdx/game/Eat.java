...
public class Eat {
    ...
    private Texture fruit_little;
    private Texture fruit_big;
   ...
   private int eat_type;
    ...
    public void render(SpriteBatch batch){
        batch.begin();
        if(eat_type==4){batch.draw(fruit_big,position.x,position.y);}
